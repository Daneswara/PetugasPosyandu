...
public class GrafikTinggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Grafik Tinggi (Laki-laki)");
        ...
        entries.add(new Entry(4, 59));
        entries.add(new Entry(5, 61));
        entries.add(new Entry(6, 62.5f));
        entries.add(new Entry(7, 64));
        entries.add(new Entry(8, 65.5f));
        entries.add(new Entry(9, 67));
        entries.add(new Entry(10, 68));
        entries.add(new Entry(11, 69));
        entries.add(new Entry(12, 70));
        entries.add(new Entry(13, 71));
        entries.add(new Entry(14, 72));
        entries.add(new Entry(15, 73.5f));
        entries.add(new Entry(16, 74.5f));
        entries.add(new Entry(17, 75));
        entries.add(new Entry(18, 76));
        entries.add(new Entry(19, 77));
        entries.add(new Entry(20, 78));
        entries.add(new Entry(21, 78.5f));
        entries.add(new Entry(22, 79.5f));
        entries.add(new Entry(23, 80));
        entries.add(new Entry(24, 81));
        entries.add(new Entry(25, 81.5f));
        entries.add(new Entry(26, 82));
        entries.add(new Entry(27, 83));
        entries.add(new Entry(28, 83.5f));
        entries.add(new Entry(29, 84));
        entries.add(new Entry(30, 85));
        entries.add(new Entry(31, 86));
        entries.add(new Entry(32, 86.5f));
        entries.add(new Entry(33, 87));
        entries.add(new Entry(34, 88));
        entries.add(new Entry(35, 88.5f));
        entries.add(new Entry(36, 89));

        List<Entry> entries2 = new ArrayList<Entry>();
        entries2.add(new Entry(0, 47));
        entries2.add(new Entry(1, 51));
        entries2.add(new Entry(2, 55));
        entries2.add(new Entry(3, 58));
        entries2.add(new Entry(4, 60));
        entries2.add(new Entry(5, 62));
        entries2.add(new Entry(6, 64));
        entries2.add(new Entry(7, 65));
        entries2.add(new Entry(8, 67));
        entries2.add(new Entry(9, 68));
        entries2.add(new Entry(10, 69.5f));
        entries2.add(new Entry(11, 71));
        entries2.add(new Entry(12, 72));
        entries2.add(new Entry(13, 73));
        entries2.add(new Entry(14, 74));
        entries2.add(new Entry(15, 75));
        entries2.add(new Entry(16, 76));
        entries2.add(new Entry(17, 77));
        entries2.add(new Entry(18, 78));
        entries2.add(new Entry(19, 79));
        entries2.add(new Entry(20, 80));
        entries2.add(new Entry(21, 80.5f));
        entries2.add(new Entry(22, 81));
        entries2.add(new Entry(23, 82));
        entries2.add(new Entry(24, 83));
        entries2.add(new Entry(25, 83.5f));
        entries2.add(new Entry(26, 84));
        entries2.add(new Entry(27, 85));
        entries2.add(new Entry(28, 86));
        entries2.add(new Entry(29, 86.5f));
        entries2.add(new Entry(30, 87));
        entries2.add(new Entry(31, 88));
        entries2.add(new Entry(32, 88.5f));
        entries2.add(new Entry(33, 89));
        entries2.add(new Entry(34, 89.5f));
        entries2.add(new Entry(35, 90));
...
//batas
        ...
        chart.getDescription().setText("Grafik Gizi Berdasarkan Tinggi Badan Untuk Laki-Laki");
