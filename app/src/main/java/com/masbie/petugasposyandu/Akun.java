...
public class Akun extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final SharedPreferences pref = getActivity().getApplicationContext().getSharedPreferences("login", 0);
...
//            this.startActivity(intent);
        ...
        String telpon = pref.getString("telp", "Tidak ada");
        String nama1 = pref.getString("nama", "Tidak ada");
        telp.setText(telpon);
        nama.setText(nama1);
